...
test_generate_password_length :: proc(t: ^testing.T) {
	...
	generate_base64_urlsafe := false
	pw := main.generate_password(allowed_chars, pass_len, generate_hex, generate_base64, generate_base64_urlsafe)
	defer delete(pw)
...
@(test)
test_generate_password_length_base64_urlsafe :: proc(t: ^testing.T) {
	allowed_chars := "ABCDEF"
	pass_len := 16
	base64_len := 22
	generate_hex := false
	generate_base64 := false
	generate_base64_urlsafe := true
	pw := main.generate_password(allowed_chars, pass_len, generate_hex, generate_base64, generate_base64_urlsafe)
	defer delete(pw)
...
test_generate_password_randomness :: proc(t: ^testing.T) {
	...
	pw1 := main.generate_password(allowed_chars, pass_len, generate_hex, generate_base64, generate_base64_urlsafe)
	defer delete(pw1)
	pw2 := main.generate_password(allowed_chars, pass_len, generate_hex, generate_base64, generate_base64_urlsafe)
	defer delete(pw2)
